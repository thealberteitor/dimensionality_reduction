...
cat(sprintf("Spearman=%.3f\n", spearman), file = "results/metrics_config_sammon_fashion_mnist.txt")
cat(sprintf("ARI=%.3f\n", ari), file = "results/metrics_config_sammon_fashion_mnist.txt", append = TRUE)
cat(sprintf("Silhouette=%.3f\n", sil), file = "results/metrics_config_sammon_fashion_mnist.txt", append = TRUE)
cat(sprintf("Trustworthiness=%.3f\n", trust), file = "results/metrics_config_sammon_fashion_mnist.txt", append = TRUE)
cat(sprintf("Continuity=%.3f\n", cont), file = "results/metrics_config_sammon_fashion_mnist.txt", append = TRUE)
...
ggsave("plots/Sammon_Mapping_fashion_mnist_plot.png", plot = p, width = 8, height = 6, dpi = 300)
