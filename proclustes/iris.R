...
cat("Ejecutando los 4 métodos de reducción de dimensionalidad...\n")
...
cat("------------------------------------------------------------\n")
cat("Matriz de Disimilitud de Procrustes (m^2) para el Dataset Iris (Corregida):\n")
cat("------------------------------------------------------------\n\n")
print(round(procrustes_matrix, 3))

dir.create("results", showWarnings = FALSE)

output_file <- "results/procrustes_matrix_iris.txt"
