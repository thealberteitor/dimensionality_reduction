...
# Carga y preprocesado del dataset Olivetti Faces
...
cat("------------------------------------------------------------\n")
cat("Matriz de Disimilitud de Procrustes (m^2) para el Dataset Olivetti Faces (Corregida):\n")
cat("------------------------------------------------------------\n\n")
...
output_file <- "results/procrustes_matrix_olivetti.txt"
