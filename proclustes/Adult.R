...
#Carga y preprocesado del dataset Adult
col_names <- c(
...
cat("Ejecutando los 4 métodos de reducción de dimensionalidad para el dataset Adult...\n")
...
cat("------------------------------------------------------------\n")
cat("Matriz de Disimilitud de Procrustes (m^2) para el Dataset Adult (Corregida):\n")
cat("------------------------------------------------------------\n\n")
print(round(procrustes_matrix, 3))

dir.create("results", showWarnings = FALSE)

output_file <- "results/procrustes_matrix_adult.txt"
